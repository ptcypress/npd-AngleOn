...
This can be used to quantify object. Preloaded values represent actual material densities & monofilament diameters. Use sliders in side panel to explore different coverage arrangements.
""")
